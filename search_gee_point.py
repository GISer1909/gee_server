...
def search(dataset, latitude, longitude, start_date, end_date, max_cloud_cover=None):
    # 创建一个点
...
if __name__ == '__main__':
    ...
    parser.add_argument('--latitude', type=float, required=True, help='Latitude for search')
    parser.add_argument('--longitude', type=float, required=True, help='Longitude for search')
    ...
    results = search(args.dataset, args.latitude, args.longitude, args.start_date, args.end_date, args.max_cloud_cover)
